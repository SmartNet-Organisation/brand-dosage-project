        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center relative">
          ...
          >
            <div className="relative px-4 sm:px-8 lg:px-0">
              ...
              {/* Floating Experience Card - Aligned with bottom of image on mobile */}
              <div className="absolute bottom-0 right-4 sm:bottom-2 sm:right-6 lg:-bottom-8 lg:-left-20 bg-white rounded-2xl p-4 md:p-5 shadow-2xl z-20 min-w-[140px] md:min-w-[160px] transform transition-all duration-500 delay-600 hover:scale-105">
                <div className="text-center">
                  ...
                  <div className="text-gray-700 text-xs md:text-sm font-bold uppercase tracking-wider leading-tight">
                    Years<br />Experience
                  </div>
                </div>
              </div>
