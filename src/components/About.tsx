        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center relative">
          ...
          >
            <div className="relative">
              ...
              {/* Floating Experience Card - Positioned lower on mobile */}
              <div className="absolute bottom-8 right-3 sm:bottom-12 sm:right-4 lg:-bottom-4 lg:-left-12 xl:-bottom-5 xl:-left-14 bg-white rounded-xl p-3 sm:p-4 lg:p-3 shadow-2xl z-20 w-24 sm:w-28 lg:w-24 xl:w-28 transform transition-all duration-500 delay-600 hover:scale-105">
