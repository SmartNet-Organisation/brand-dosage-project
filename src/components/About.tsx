        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center relative">
          ...
          >
            <div className="relative">
              ...
              {/* Floating Experience Card - Positioned in front of the image */}
              <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 bg-white rounded-3xl p-6 md:p-8 shadow-2xl z-20 min-w-[180px] md:min-w-[220px] transform transition-all duration-500 delay-600 hover:scale-105">
