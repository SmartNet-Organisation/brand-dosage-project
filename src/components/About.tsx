        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center relative">
          ...
          >
            <div className="relative">
              ...
              {/* Floating Experience Card - Positioned further left and smaller */}
              <div className="absolute bottom-8 -left-16 md:bottom-12 md:-left-20 bg-white rounded-2xl p-4 md:p-5 shadow-2xl z-20 min-w-[140px] md:min-w-[160px] transform transition-all duration-500 delay-600 hover:scale-105">
