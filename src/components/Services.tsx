      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {services.map((service, index) => (
            <div
              key={index}
              className={`group bg-white hover:bg-gradient-to-br hover:from-green-50 hover:to-green-100 rounded-2xl transition-all duration-500 hover:shadow-xl border border-gray-100 hover:border-green-200 overflow-hidden ${servicesVisible ? 'animate-slide-in-right' : ''
                }`}
