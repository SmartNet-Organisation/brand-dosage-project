        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center relative">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 lg:-bottom-4 lg:-left-12 xl:-bottom-5 xl:-left-14 bg-white rounded-xl p-2 sm:p-3 lg:p-3 shadow-2xl z-20 min-w-[80px] sm:min-w-[90px] lg:min-w-[50px] transform transition-all duration-500 delay-600 hover:scale-105">
