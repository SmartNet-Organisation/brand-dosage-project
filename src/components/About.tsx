    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center relative">
          ...
          {/* Floating Experience Card - Positioned between left content and image */}
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 lg:left-auto lg:transform-none lg:bottom-8 lg:-translate-x-8 bg-white rounded-3xl p-6 md:p-8 shadow-2xl z-10 min-w-[180px] md:min-w-[220px] transition-all duration-500 delay-600 hover:scale-105 order-3">
